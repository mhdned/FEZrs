...
class IRHSVCalculator(BaseTool):
    def __init__(self, red_path: PathLike, swir1_path: PathLike, swir2_path: PathLike):
        ...
        self.__irhsv_output: np.ndarray | None = None
    ...
    def calculate(self):
        ...
        self.__irhsv_output = rgb2hsv(np.dstack((swir2, swir1, red)))
        return self.__irhsv_output
    ...
    def export_file(self,
            ...
            filename_prefix: str = "IRHSV_output",
            dpi: int = 500,
            grid: bool = True
        ):
        if self.__irhsv_output is None:
            raise ValueError("IRHSV data not computed. Run `calculate()` before exporting.")
        ...
        im = ax.imshow(self.__irhsv_output, cmap=colormap)
...
if __name__ == "__main__":
    ...
    calculator = IRHSVCalculator(red_path=red_path, swir1_path=swir1_path, swir2_path=swir2_path)
