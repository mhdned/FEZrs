...
class VALUECalculator(BaseTool):
    ...
    def __init__(self, nir_path: PathLike, blue_path: PathLike, green_path: PathLike):
        ...
        self.__value_output: np.ndarray | None = None
    ...
    def calculate(self):
        ...
        self.__value_output = rgb2hsv(np.dstack((nir, green, blue)))
        self.__value_output = self.__value_output[:,:,2]
    ...
    def export_file(self,
            ...
            filename_prefix: str = "VALUE_output",
            dpi: int = 500,
            grid: bool = True
        ):
        
        if self.__value_output is None:
            raise ValueError("VALUE data not computed. Run `calculate()` before exporting.")
        ...
        im = ax.imshow(self.__value_output, cmap=colormap)
...
if __name__ == "__main__":
    ...
    calculator = VALUECalculator(blue_path=blue_path, green_path=green_path, nir_path=nir_path)
