...
class IRHUECalculator(BaseTool):
    def __init__(self, red_path: PathLike, swir1_path: PathLike, swir2_path: PathLike):
        ...
        self.__irhue_output: np.ndarray | None = None
    ...
    def calculate(self):
        ...
        self.__irhue_output = rgb2hsv(np.dstack((swir2, swir1, red)))
        self.__irhue_output = self.__irhue_output[:,:,0]
        return self.__irhue_output
    ...
    def export_file(self,
            ...
            filename_prefix: str = "IRHUE_output",
            dpi: int = 500,
            grid: bool = False
        ):
        if self.__irhue_output is None:
            raise ValueError("IRHUE data not computed. Run `calculate()` before exporting.")
        ...
        im = ax.imshow(self.__irhue_output, cmap=colormap)
...
if __name__ == "__main__":
    ...
    calculator = IRHUECalculator(red_path=red_path, swir1_path=swir1_path, swir2_path=swir2_path)
