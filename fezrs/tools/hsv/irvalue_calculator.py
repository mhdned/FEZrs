...
class IRVALUECalculator(BaseTool):
    def __init__(self, red_path: PathLike, swir1_path: PathLike, swir2_path: PathLike):
        ...
        self.__irvalue_output: np.ndarray | None = None
    ...
    def calculate(self):
        ...
        self.__irvalue_output = rgb2hsv(np.dstack((swir2, swir1, red)))
        self.__irvalue_output = self.__irvalue_output[:,:,2]
        return self.__irvalue_output
    ...
    def export_file(self,
            ...
            filename_prefix: str = "IRVALUE_output",
            dpi: int = 500,
            grid: bool = False
        ):
        if self.__irvalue_output is None:
            raise ValueError("IRVALUE data not computed. Run `calculate()` before exporting.")
        ...
        im = ax.imshow(self.__irvalue_output, cmap=colormap)
...
if __name__ == "__main__":
    ...
    calculator = IRVALUECalculator(red_path=red_path, swir1_path=swir1_path, swir2_path=swir2_path)
